...
func (r *rpcClient) RequestGetOrCreateChannelClusterConfig(nodeId uint64, channelId string, channelType uint8) (msdb.ChannelClusterConfig, error) {
	...
	config := msdb.ChannelClusterConfig{}
...
func (r *rpcClient) RequestGetChannelClusterConfig(nodeId uint64, channelId string, channelType uint8) (msdb.ChannelClusterConfig, error) {
...
func (r *rpcClient) RequestWakeLeaderIfNeed(nodeId uint64, config msdb.ChannelClusterConfig) error {
...
func (r *rpcClient) RequestChannelSwitchConfig(nodeId uint64, config msdb.ChannelClusterConfig) error {
	data, err := config.Marshal()
	if err != nil {
		return err
	}
