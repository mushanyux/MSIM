...
func (r *rpcServer) handleChannelPropose(c *msserver.Context) {
...
func (r *rpcServer) handleGetOrCreateChannelConfig(c *msserver.Context) {
	req := &channelReq{}
	if err := req.decode(c.Body()); err != nil {
...
func (r *rpcServer) handleChannelConfig(c *msserver.Context) {
	req := &channelReq{}
	if err := req.decode(c.Body()); err != nil {
		r.Error("decode channel config req failed", zap.Error(err))
		c.WriteErr(err)
...
func (r *rpcServer) handleSlotLastLogInfo(c *msserver.Context) {
	req := &SlotLogInfoReq{}
...
func (r *rpcServer) handleWakeLeaderIfNeed(c *msserver.Context) {
...
func (r *rpcServer) handleChannelSwitchConfig(c *msserver.Context) {
	cfg := msdb.ChannelClusterConfig{}
	if err := cfg.Unmarshal(c.Body()); err != nil {
...
func (r *rpcServer) handleChannelLastLogInfo(c *msserver.Context) {
	req := &channelReq{}
	if err := req.decode(c.Body()); err != nil {
...
func (r *rpcServer) handleClusterJoin(c *msserver.Context) {
	req := &ClusterJoinReq{}
	if err := req.Unmarshal(c.Body()); err != nil {
...
func (r *rpcServer) handleClusterLogs(c *msserver.Context) {
	req := &clusterLogsReq{}
	if err := req.decode(c.Body()); err != nil {
