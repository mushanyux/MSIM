...
// - protoc             v6.31.1
// source: pkg/mshook/webhook.proto
...
func (c *webhookServiceClient) SendWebhook(ctx context.Context, in *EventReq, opts ...grpc.CallOption) (*EventResp, error) {
	out := new(EventResp)
	err := c.cc.Invoke(ctx, "/mshook.WebhookService/SendWebhook", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _WebhookService_SendWebhook_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mshook.WebhookService/SendWebhook",
	}
...
var WebhookService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "mshook.WebhookService",
	...
	Metadata: "pkg/mshook/webhook.proto",
}
