...
func (d *metrics) Route(r *mshttp.MSHttp) {
...
func (d *metrics) appMetrics(c *mshttp.Context) {
...
func (d *metrics) clusterMetrics(c *mshttp.Context) {
	latestStr := c.Query("latest")
	var latest int64
	if latestStr != "" {
		latest, _ = strconv.ParseInt(latestStr, 10, 64)
...
func (d *metrics) systemMetrics(c *mshttp.Context) {
	latestStr := c.Query("latest")
	var latest int64
	if latestStr != "" {
		latest, _ = strconv.ParseInt(latestStr, 10, 64)
