...
func (s *apiServer) start() {
	...
	s.r.Use(func(c *mshttp.Context) {         // 管理者权限判断
...
func (s *apiServer) setRoutes() {
	...
	s.r.GET("/health", func(c *mshttp.Context) {
	...
	s.r.GET("/migrate/result", func(c *mshttp.Context) {
...
func (s *apiServer) jwtAndTokenAuthSetMiddleware() mshttp.HandlerFunc {
...
func bandwidthMiddleware() mshttp.HandlerFunc {
